...
public class Variant9Test {
    ...
    public void negativeIntegerTest() { new Variant9().integerNumbersTask(-2); }
    ...
    public void arrayTest(int[] arr, int[] value) {
        assertEquals(new Variant9().arrayTask(arr), value);
    }

    @DataProvider
    public Object[][] arrayProvider() {
        return new Object[][] { { new int[] { 10, 2, 3 }, new int[] {2, 10} }, { new int[] {1, 3 ,5, 7, 9}, new int[] {}}, { new int[]{4, 3, 5, -4, 9, 2, 10, 23, 123, -92, 100}, new int[]{100, -92, 10, 2, -4, 4}}};
    }

    @Test(dataProvider = "matrixProvider")
    public void twoDimensionArrayTest(int[][] input, int[][] res) {
        assertEquals(new Variant9().twoDimensionArrayTask(input), res);
    }
    ...
    public Object[][] matrixProvider() {
        ...
        return new Object[][] {{input, new int[][]{ {34, 98, -9, 2, 1}, {-98, 8, 1, 5, 3}}}, {input2, new int[][]{{4, 5, 6}, {10, 11, 12}}}};
    }
}
